---
title: "R Practical 01 -  Introduction"
...
```{r}
gcGenes<-read.delim("C:/Users/chris/Dropbox/github/MolBioMedClass/Datasets/SCgenes_gcContent.tsv", header=T, sep="\t")
gcRegSeq<-read.delim("C:/Users/chris/Dropbox/github/MolBioMedClass/Datasets/SCRegSeq_gcContent.tsv", header=T, sep="\t")
```
...
```{r}
real<-read.table("C:/Users/chris/Dropbox/github/MolBioMedClass/Datasets/bballshots.txt")[,1]
```
